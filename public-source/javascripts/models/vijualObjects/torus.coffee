class App.VO.Torus extends App.VO.Base3d
  ...
  attributeControls: -> $.extend super,
    ...
    'geometry.radialSegments': { type: 'integerSlider', name: 'Radial Seg.', max: 40, pos: [4, 3, 4, 1] }
    'geometry.tubularSegments': { type: 'integerSlider', name: 'Tube Seg.', max: 40, pos: [4, 4, 4, 1] }
    'geometry.arc': { type: 'angle', name: 'Arc', pos: [8, 3, 4, 2] }
