class App.VO.Ring extends App.VO.Base3d
  ...
  attributeControls: -> $.extend super,
    'geometry.innerRadius': { type: 'slider', name: 'Inner Rad.', pos: [0, 4, 4, 1] }
    'geometry.outerRadius': { type: 'slider', name: 'Outer Rad.', pos: [0, 5, 4, 1] }
    'geometry.thetaSegments': { type: 'integerSlider', name: 'Theta Seg.', max: 40, pos: [4, 4, 4, 1] }
    'geometry.phiSegments': { type: 'integerSlider', name: 'Phi Seg.', pos: [4, 5, 4, 1] }
    'geometry.thetaStart': { type: 'angle', name: 'Start', pos: [8, 4, 2, 2] }
    'geometry.thetaLength': { type: 'angle', name: 'Length', pos: [10, 4, 2, 2] }
