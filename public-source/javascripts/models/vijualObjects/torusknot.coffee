class App.VO.TorusKnot extends App.VO.Base3d
  ...
  attributeControls: -> $.extend super,
    ...
    'geometry.tube': { type: 'slider', name: 'Tube', pos: [0, 4, 4, 1] }
    'geometry.radialSegments': { type: 'integerSlider', name: 'Radial Seg.', max: 200, pos: [4, 3, 4, 1] }
    'geometry.tubularSegments': { type: 'integerSlider', name: 'Tube Seg.', max: 16, pos: [4, 4, 4, 1] }
    'geometry.p': { type: 'integerSlider', name: 'P', max: 20, pos: [8, 3, 4, 1] }
    'geometry.q': { type: 'integerSlider', name: 'Q', max: 20, pos: [8, 4, 4, 1] }
