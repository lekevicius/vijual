class App.VO.Circle extends App.VO.Base3d
  ...
  attributeControls: -> $.extend super,
    ...
    'geometry.segments': { type: 'integerSlider', name: 'Theta Seg.', max: 40, pos: [4, 4, 4, 1] }
    'geometry.thetaStart': { type: 'angle', name: 'Start', pos: [8, 4, 2, 1] }
    'geometry.thetaLength': { type: 'angle', name: 'Length', pos: [10, 4, 2, 1] }
