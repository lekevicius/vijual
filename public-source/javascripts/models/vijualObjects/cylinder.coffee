class App.VO.Cylinder extends App.VO.Base3d
  ...
  attributeControls: -> $.extend super,
    'geometry.radiusTop': { type: 'slider', name: 'Rad. Top', pos: [0, 3, 4, 1] }
    'geometry.radiusBottom': { type: 'slider', name: 'Rad. Bottom', pos: [4, 3, 4, 1] }
    'geometry.height': { type: 'slider', name: 'Height', pos: [8, 3, 4, 1] }
    'geometry.radiusSegments': { type: 'integerSlider', name: 'Radius Seg.', max: 40, pos: [0, 4, 4, 1] }
    'geometry.heightSegments': { type: 'integerSlider', name: 'Height Seg.', max: 40, pos: [4, 4, 4, 1] }
    'geometry.openEnded': { type: 'toggle', name: 'Open', pos: [8, 4, 4, 1] }
