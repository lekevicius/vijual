class App.VO.Sphere extends App.VO.Base3d
  ...
  attributeControls: -> $.extend super,
    ...
    'geometry.widthSegments': { type: 'integerSlider', name: 'Width Seg.', max: 40, pos: [0, 5, 4, 1] }
    'geometry.heightSegments': { type: 'integerSlider', name: 'Height Seg.', max: 40, pos: [0, 6, 4, 1] }
    'geometry.phiStart': { type: 'angle', name: 'Start', pos: [4, 4, 2, 3] }
    'geometry.phiLength': { type: 'angle', name: 'Length', pos: [6, 4, 2, 3] }
    'geometry.thetaStart': { type: 'angle', name: 'Start', pos: [8, 4, 2, 3] }
    'geometry.thetaLength': { type: 'angle', name: 'Length', pos: [10, 4, 2, 3] }
